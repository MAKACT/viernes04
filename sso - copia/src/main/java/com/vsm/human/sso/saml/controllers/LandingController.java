package com.vsm.human.sso.saml.controllers;
...
import com.vsm.human.sso.saml.dto.EmployeeDto;
import com.vsm.human.sso.saml.stereotypes.CurrentUser;

@Controller
public class LandingController {
	@Value("${saml.auth.page.controller.login.url.succes}")
	private String LOGIN_SAML_SUCCESS;

	@Value("${saml.auth.page.controller.query.credentials}")
	private String QUERY_GET_CREDENTIALS;

	@Value("${saml.auth.page.controller.query.implants}")
	private String QUERY_GET_CREDENTIALS_IMPLANTS;

	@Value("${saml.auth.page.controller.error.login.many.emails}")
	private String MANY_EMAILS_MESSAGE;

	@Value("${saml.auth.page.controller.error.login.empty.email}")
	private String EMPTY_EMAIL_MESSAGE;

	@Value("${saml.auth.page.controller.error.login.simlate.count}")
	private String SIMULATE_ACOUNT_MESSAGE;

	@Value("${saml.auth.page.controller.login.url.error}")
