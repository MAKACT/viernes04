package com.vsm.human.sso.saml.config;
...
import com.vsm.human.sso.saml.core.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
	...
	@Value("${saml.service.provider.entity.id}")
	private String serviceProviderEntityId;

	@Value("${saml.idp.metedata.url}")
	...
	public WebSSOProfileConsumer webSSOprofileConsumer() {
		...
		webSSOProfileConsumerImpl.setResponseSkew(10800);
		webSSOProfileConsumerImpl.setMaxAuthenticationAge(86400 * 365);
